...
function duola_migration_render_admin_page(): void
{
    ...
    <div class="wrap duola-migration-page">
        ...
        <p><?php esc_html_e('迁移包包含文章、标签、相册、异世界动画与关联关系、全部图片原图、留言与点赞数、网站头像和基础站点信息。主题代码和 Docker 配置仍由 Git 管理。', 'duola-albums'); ?></p>
        ...
        <?php if (isset($_GET['duola_imported'])) : ?>
            <div class="notice notice-success is-dismissible"><p>
                ...
                echo esc_html(sprintf(
                    __('导入完成：%1$d 篇文章、%2$d 本相册、%3$d 部动画、%4$d 张图片、%5$d 条留言与回复。', 'duola-albums'),
                    absint($_GET['posts'] ?? 0),
